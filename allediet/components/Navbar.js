...
export const Navbar = () => {
    return (
        <>
            <nav className="py-3 fixed top-0 left-0 right-0 bottom-auto shadow-sm">
                <div className="flex flex-row items-center mx-auto justify-around text-center max-w-7xl">
                    <div id="logo" className="flex flex-row gap-2 items-center ">
                        ...
                        <p className="text-2xl font-semibold hover:scale-100">alle Diet</p>
                    </div>
                    <div id="right-section" className="flex flex-row gap-5 items-center">
                        ...
                        <p className="hover:text-violet text-lg border p-2 border-solid border-violet rounded-2xl text-violet">Umów wizytę</p>
                    </div>
                </div>
            </nav>
        </>
